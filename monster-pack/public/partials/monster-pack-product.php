    ...
    <div id="PRD1" class="row row-large d-none" style="display:none;">
        ...
        <div class="col medium-6 small-12 large-6 pb-0">
            <form id="prd_form" name="prd_form" method="POST" class="col-inner text-center" style="padding-top:25px;">
                ...
                <div class="row">
                    <div class="col medium-6 small-6 large-6">
                        <input type="tel" id="prd_contact" name="prd_contact" class="form-control" placeholder="Contact Number" required="" />
                    </div>
                    <div class="col medium-6 small-6 large-6">
                        <input type="tel" id="prd_postcode" name="prd_postcode" required="" pattern="[0-9]{4}" class="form-control" placeholder="Post Code"
                        />
                    </div>
                </div>
                <div class="row">
